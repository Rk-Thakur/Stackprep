...
import '../../widgets/terminal_text_field.dart';
import '../onboarding/select_stack_screen.dart';

/// Terminal-themed sign-in / create-account screen, backed by Firebase Auth
/// via [AuthBloc].
...
class _AuthScreenState extends State<AuthScreen> {
  ...
  void _continueAnonymously() {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (_) => const SelectStackScreen()),
    );
  }
