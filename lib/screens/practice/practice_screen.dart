                    ...
                    for (final track in kStackTracks)
                      Padding(
                        ...
                        child: _TrackCard(
                          ...
                          onTap: () => Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (_) => const TopicDetailScreen(),
                            ),
                          ),
                        ),
                      ),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        // The accent shape bleeds off the corner via a negative Positioned
        // offset, so it needs an explicit ClipRRect (matching the card's own
        // radius) to crop along the curve — Stack's default hardEdge clip
        // would chop it off in a straight line instead.
        child: ClipRRect(
          borderRadius: AppRadius.radiusLg,
          child: Stack(
            children: [
